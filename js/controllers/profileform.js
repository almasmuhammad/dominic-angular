myApp.controller('ProfileFormController',
  ...
  function($scope, $rootScope, $firebaseAuth, $firebaseArray, FIREBASE_URL) {
    ...
    firebase.auth().onAuthStateChanged(function(user) {
        ...
        firebase.database().ref('/associates/' + user.uid).once('value').then(function(snapshot) {
            ...
            var storageRef = firebase.storage().ref().child('/images/' + user.uid);
